...
| **C** - Conclusion & Comparison | GitHub Copilot (Claude 4.6) | (Geplant) Bewertung der Modellgüte und Selektion des finalen Modells. | "Vergleiche die RMSE-Werte der Modelle und visualisiere die Residuen." |
| **K** - Knowledge Transfer | GitHub Copilot (Claude 4.6) | Erstellung von verständlicher Dokumentation (`README.md`, `GLOSSARY.md`) und Vorbereitung der Streamlit-App. | "Erstelle ein Glossar für Nicht-Experten, das Begriffe wie 'RMSE' und 'Hitzetag' einfach erklärt." | 
